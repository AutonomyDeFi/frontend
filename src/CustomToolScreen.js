  ...
  return (
    ...
    <Container>
      <Paper elevation={3} sx={style.container}>
        ...
        <div className="input_addtool" style={style.inputContainer}>
          ...
          />
          <Button variant="contained" onClick={handleOpen} sx={style.createToolButton}>
            Create Tool
          </Button>
        </div>
    ...
    >
      <Box sx={style.modal}>
        ...
        <div > 
        <Button onClick={handleClose} sx={{ mt: 1 }} variant="outlined">
          Create Another Tool
        </Button>
        <Button
