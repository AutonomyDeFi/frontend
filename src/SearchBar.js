...
export default function CustomizedInputBase({navigation}) {
  ...
  return (
    <Paper
      component="form"
      sx={{ p: '2px 4px', display: 'flex', justifyContent: "center", alignItems: 'center', width: 700 }} style={{maxWidth: "75%", marginLeft: "auto", marginRight:"auto"}}
    >
